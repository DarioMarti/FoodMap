export default function Tarjeta_chat() {
    return (
        <div className="w-full flex border-b-3 border-borde  dark:border-text-tertiary  p-4 justify-between bg-background dark:bg-dark-tarjeta">
            <div className=" h-24 p-3 rounded-2xl flex gap-6">
                <img className="size-16 rounded-full bg-amber-600" src="" alt="" />
                <div className="flex-1">
                    <strong className="text-md font-semibold text-2xl text-text-main dark:text-background">María</strong>
                    <p className="text-lg font-light mt-1 text-text-tertiary dark:text-background-oscur">¿Qué vamos a comer hoy?</p>
                </div>
            </div>
