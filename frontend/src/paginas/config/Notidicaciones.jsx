    ...
    return (
        <div className="h-full flex flex-col overflow-hidden dark:bg-text-main bg-background">
            ...
            <article className="p-10 flex-1 overflow-y-auto">
                ...
                <h2 className="text-2xl font-bold py-10 px-2 dark:text-white text-text-main">Permisos</h2>
                <div className="flex flex-col gap-6 bg-background dark:bg-dark-tarjeta border-3 border-borde dark:border-text-tertiary py-8 rounded-3xl ">
                    <div className="flex justify-between px-10">
                        <strong className="text-xl font-semibold dark:text-white text-text-main">Invitaciones de amistad</strong>
                        <Toggle id="invitaciones-amistad" />
                    </div>
                    <span className=" h-1 bg-borde w-full dark:bg-text-tertiary"></span>
                    <div className="flex justify-between px-10 items-center">
                        <strong className="text-xl font-semibold dark:text-white text-text-main">Invitaciones a grupos</strong>
                        <Toggle id="invitaciones-grupos" />
                    </div>
                    <span className=" h-1 bg-borde w-full dark:bg-text-tertiary"></span>
                    <div className="flex justify-between px-10 items-center">
                        <strong className="text-xl font-semibold dark:text-white text-text-main">Mensajes de chat</strong>
