    ...
    return (
        <div className="h-full flex flex-col overflow-hidden dark:bg-text-main bg-background">
            ...
            <article className="p-10 flex-1 overflow-y-auto">
                ...
                <div className="flex flex-col gap-0 bg-background dark:bg-dark-tarjeta border-3 border-borde dark:border-text-tertiary rounded-3xl overflow-hidden ">
                    {faqs.map((faq, index) => (
                        <div key={index}>
                            ...
                            {index < faqs.length - 1 && <span className="h-0.5 bg-borde w-full block  dark:border-1 dark:border-text-tertiary"></span>}
                        </div>
                    ))}
                </div>

                <h2 className="text-2xl font-bold py-10 px-2 dark:text-white text-text-main">Contacto y Soporte</h2>
                <div className="grid grid-cols-2 gap-6 mb-4">
                    <div className="p-8 bg-background dark:bg-dark-tarjeta border-3 border-borde dark:border-text-tertiary rounded-3xl flex flex-col items-center text-center gap-4 hover:border-primary transition-colors group">
                        ...
                        <div>
                            <strong className="text-xl font-semibold dark:text-white text-text-main">Chat en vivo</strong>
                    ...
                    <div className="p-8 bg-background dark:bg-dark-tarjeta border-3 border-borde dark:border-text-tertiary rounded-3xl flex flex-col items-center text-center gap-4 hover:border-primary transition-colors group">
                        ...
                        <div>
                            <strong className="text-xl font-semibold dark:text-white text-text-main">Centro de ayuda</strong>
                ...
                <div className="flex flex-col gap-6 bg-background border-3 border-borde dark:border-text-tertiary py-8 rounded-3xl dark:bg-dark-tarjeta ">
                    ...
                    <span className=" h-1 bg-borde w-full dark:border-1 dark:bg-text-tertiary "></span>
                    <div className="flex justify-between px-10 items-center cursor-pointer group">
                        <div className="flex items-center gap-4">
