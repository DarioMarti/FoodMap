...
export default function Ayuda() {
    ...
    return (
        <div className="h-full flex flex-col overflow-hidden dark:bg-background-oscuro bg-background md-pb-0 pb-20">
            ...
            <article className="p-5 md:p-10 flex-1 overflow-y-auto">
                ...
                <div className="flex flex-col gap-6 bg-background border-3 border-borde dark:border-white/10 py-8 rounded-3xl dark:bg-dark-tarjeta ">
                    <div className="flex justify-between px-4 md:px-10 items-center cursor-pointer group">
